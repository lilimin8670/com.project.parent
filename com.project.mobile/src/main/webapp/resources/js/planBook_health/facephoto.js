document.querySelector('input.faceI').addEventListener('change', function () {
...
document.querySelector('input.faceII').addEventListener('change', function () {
...
document.querySelector('input.faceIII').addEventListener('change', function () {
    ...
    lrz(that.files[0], {
        ...
        .then(function (rst) {
            ...
            img.onload = function () {
                document.querySelector('#upload-containerThree').appendChild(div);
            };
            img.src = rst.base64;
            return rst;
        });
	$(this).parent(".upload_face3").parent('.col-xs-12').parent('.row').find('span.fa3').show();
	$('.upload_face3').hide();
});
