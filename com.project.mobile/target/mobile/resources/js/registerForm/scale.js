	...
	ImagesZoom.prototype = {
		...
		init: function(param){
			...
			var imgList   = document.querySelectorAll(params.elem + " img"),
				zoomMask  = document.querySelector(".imgZoomPack"),
				zoomImg   = document.querySelector(".imgZoomPack .imgzoom_img img"),
				zoomClose = document.querySelector(".imgZoomPack .return_btn"),
                zoomDelete = document.querySelector(".imgZoomPack .btn_delete"),
                zoomDownload = document.querySelector(".imgZoomPack .btn_download"),
				imgSrc    = "";
			...
			//删除
            zoomDelete.addEventListener("click", function(){
                zoomImg.style.cssText = "";
            ...
            //下载
            zoomDownload.addEventListener("click", function(){
...
;					zoomImg.onload = function(){
		...
		addEventStart: function(param){
			...
			self.element = document.querySelector(".imgZoomPack img");
