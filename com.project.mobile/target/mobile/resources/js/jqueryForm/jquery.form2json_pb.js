/**
 * Created by xuanYin on 2017/3/22.
 */
(function($) {

    var defaults = {
            inputSelectors: 'input:not([type=radio], [type=checkbox], [type=reset]), input[type=checkbox], input[type=radio], textarea, select',
        ...
        singleVal.each(function() {
            ...
            if (key) {
                ...
                if($(this).is("input[type='radio']")){
                    val=item.is(':radio:not(:checked)') ? null : item.val();
                    if(!val){
                        if(key==keyRemeber){
                            return true;
                        }
