    ...
    u = function() {
        this.config = {
            verify: {
                required: [/[\S]+/, "必填项不能为空"],
                sex:function(value){
		        	 var fleg=$('input[name="sex"]').is(":checked");
		        	 var radioId=$('input[name="sex"]:first').parent("div").attr('id');
		        	 if(!fleg){
		        	 	window.location.hash='#'+radioId;
		        	 	return "性别为必选项"
		        	 }
		        },
		        numpoint:function(value){
		         	var textValid = /^[1-9]\d*\.\d*|0\.\d*[1-9]\d\*$|^[1-9]\d*$/;
		         	if(value!="" && !textValid.test(value)){
		         		return "输入不符合规范"
		         	 }
		        },
		        ...
		        date:function(value){
		        	...
		        	if(value!=""&&!dateval.test(value)){
		        		return "日期格式不正确"
		        	}
		        },
		        identity:function(value){
		        	var identity = /(^\d{15}$)|(^\d{17}(x|X|\d)$)/;
		        	if(value!=""&&!identity.test(value)){
		        		return "请输入正确的身份证号"
		        	}
		        },
		        year:function(value){
		        	var year=/^\d{4}$/;
		        	if(value!=""&&!year.test(value)){
		        		return "请输入正确的年份"
		        	}
		        },
		        mouth:function(value){
		        	var mouth=/^(0?[1-9]|1[0-2])$/;
		        	if(value!="" && !mouth.test(value)){
		        		return "请输入正确的月份"
		        	}
		        },
		        day:function(value){
		        ...
		        face:function(value){
		        	var face = /^[1-3]$/;
		        	if(value!=""&&!face.test(value)){
		        		return "请输入正确格式"
		        	}
		        },
		        selec:function(value){
		        	if(value==""){
		        		window.location.hash='#kaji';
		        	}
		        }
            }
        }
